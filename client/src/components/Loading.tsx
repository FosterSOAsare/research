...
const Loading: React.FC<LoadingProps> = ({ stroke = "#000000", sx = "" }) => {
	return (
		<>
			<div className="w-auto h-auto justify-center items-center">
				<svg className={`animate-spin -ml-1 mr-3 h-8 w-8 text-white ${sx}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
